...
class AccountPaymentOrder(models.Model):
    ...
    @api.onchange('payment_mode_id')
    @api.depends('payment_mode_id.payment_type')
    def domain_jurnal(self):
        a = {}
        if self.payment_mode_id.payment_type == 'outbound':
            print ("kkkkkkkkkkkkkkkk")
            a = {'payment_line_ids': [('move_line_id.account_id.user_type_id.name', '=', 'Payable')]}
            print (a,"aaaaaaaaaaaaa")
            return {'domain': a}
        elif self.payment_mode_id.payment_type == 'inbound':
            a = {'payment_line_ids': [('move_line_id.account_id.user_type_id.name', '=', 'Receivable')]}
            return {'domain': a}
    ...
    def direct_payment(self):
        for x in self.payment_line_ids:
            if x.move_line_id.invoice_id:
                x.move_line_id.invoice_id.payment_order_id = self.id
