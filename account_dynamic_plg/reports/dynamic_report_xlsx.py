...
class PartnerLedgerXlsx(ReportXlsx):
            ...
            for line in Accounts:
                ...
                if line['main']:
                    ...
                    self.sheet.write_string(self.row_pos, 6, self._format_currency(line['debit-credit'], line['precision']),
                                            self.line_header)
                if not line['main']:
                    self.sheet.write_string(self.row_pos, 0, line['date'],
                    ...
                    if Filters['form']['amount_currency']:
                        if line['currency_id']:
                            a = str(line['amount_currency']) + str(line['currency_code'])
...
PartnerLedgerXlsx('report.account_dynamic_plg.partner_ledger_xlsx',
