...
var DynamicPlgMain = Widget.extend({
...
var ControlButtonsPlg = Widget.extend({
	...
	download_pdf : function(event){
        ...
        return new Model('report.account.dynamic.report_partnerledger')
...
var UserFiltersPlg = Widget.extend({
	...
	start : function(){
        ...
        var a = new Model('account.journal')
            .query(['name','id','code'])
            .all()
        ...
        self.$el.find('#from_date_plg').datetimepicker({
                    ...
                    viewMode: 'days',
                    format: time.strftime_to_moment_format(_t.database.parameters.date_format),
